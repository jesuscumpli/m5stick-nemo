  ...
  #define TXT_RG_CUSTOM "Region: Custom"
  ...
  #define TXT_CLOCK "Reloj"
  #define TXT_SETTINGS "Ajustes"
  #define TXT_NEVER "Nunca"
  #define TXT_SEC "segundos"
  #define TXT_MIN	"minutos"
  #define TXT_AUTO_DIM "AJUSTAR LUZ FONDO"
  #define TXT_SET_BRIGHT "AJUSTAR BRILLO"
  #define TXT_BATT_INFO "Info Bateria"
  #define TXT_BRIGHT "Brillo"
  #define TXT_SET_CLOCK "Config. Reloj"
  #define TXT_ROTATION "Rotacion"
  #define TXT_ABOUT "Sobre"
  #define TXT_REBOOT "Reiniciar"
  #define TXT_CLR_SETTINGS "Limpiar Ajustes"
  #define TXT_CLRING_SETTINGS "Aplicando Ajustes\nPor Defecto..."
  #define TXT_RIGHT "Derecha"
  #define TXT_LEFT "Izquierda"
  #define TXT_BATT "Bateria: "
  #define TXT_EXIT "Presione tecla para salir"
  #define TXT_RG_AMERICAS "Region:\nAmerica / Asia\n"
  #define TXT_RG_EMEA "Region: EMEA"
  #define TXT_SEL_GO_PAUSE "OK: Iniciar/Parar"
  #define TXT_SEL_EXIT "Sig: Salir"
  #define TXT_TRIG_TV "TVBG lanzado"
  #define TXT_MN_AMERICA "America / Asia"
  #define TXT_MN_EMEA "EU/MidEast/Africa"
  #define TXT_REGION "Region"
  #define TXT_FK_GP "Sig: Ir/Parar"
  #define TXT_SET_HOUR "AJUSTAR HORA"
  #define TXT_SET_MIN "AJUSTAR MINUTO"
  #define TXT_ADV "Anuncio:\n"
  #define TXT_SP_RND "Swift Pair Aleatorio"
  #define TXT_SEL_EXIT2 "\n\nSig: Salir"
  #define TXT_BT_SPAM "BT Spam"
  #define TXT_SA_CRASH "SourApple Crash"
  ...
  #define TXT_AD_SPAM "Android Spam"
  #define TXT_AJ_TRANSF_NM "Transferir Numero"
  #define TXT_AJ_TV_COLOR "Balance Color TV"
  #define TXT_STP_NW_PH "Nuevo Movil"
  #define TXT_SA_ADV "Anuncio SourApple: "
  #define TXT_SP_ADV "Anuncio SwiftPair: '%s' - "
  #define TXT_AD_SPAM_ADV "Anuncio Android Spam: "
  #define TXT_AJ_ADV "Anuncio AppleJuice: "
  #define TXT_WF_SP "WiFi Spam"
  #define TXT_RND_SSID " - SSIDs Aleatorio\n"
  #define TXT_WF_SCAN "Escanear Wifi"
  #define TXT_WF_SPAM_FUN "Spam Funny"
  #define TXT_WF_SPAM_RR "Spam Rickroll"
  #define TXT_WF_SPAM_RND "Spam Aleatorio"
  #define TXT_WF_RESCAN "[REESCANEAR]"
  #define TXT_WF_OPEN "Abierto"
  #define TXT_WF_CHANN "Canal: %d\n"
  #define TXT_WF_CRYPT "Cripto: %s\n"
  #define TXT_SEL_BACK "\nSig: Atras\n"
  #define TXT_HOLD_CLONE "Manten OK: Clonar\n"
  #define TXT_WF_SCN "Escanear WiFi"
  #define TXT_WF_SCNING "Escaneando..."
  #define TXT_INST_NXT "Sig: Flecha Abajo"
  #define TXT_INST_PRV "Ant: Flecha Arriba"
  #define TXT_INST_SEL "OK: Intro o ->   "
  #define TXT_INST_HOME "Inicio: Esc  o <- "
  #define TXT_INST_PRSS_KEY "  Presione una tecla"
  #define TXT_STK_NXT "Sig: Boton Lateral"
  #define TXT_STK_SEL "OK: Boton M5"
  #define TXT_STK_HOME "Inicio: Boton Power"
  #define TXT_SDCARD "Montar/Desmon. SD"
  #define TXT_DEAUTH_START "OK>Iniciar DEAUTH\n"
  #define TXT_DEAUTH_STOP "OK>Detener DEAUTH\n"
  #define TXT_HOLD_ATTACK "Manten OK: Ataque\n"
  #define TXT_WFA_PORTAL "Clonar Portal"
  #define TXT_WFA_DEAUTH "Ataque Deauth"
  #define TXT_WFA_COMBINED "Deauth+Clon"
  #define TXT_BLACK "Negro"
  #define TXT_NAVY "Navy"
  #define TXT_DARKGREEN "Verde Oscuro"
  #define TXT_DARKCYAN "Cyan Oscuro"
  #define TXT_MAROON "Marron"
  #define TXT_PURPLE "Morado"
  #define TXT_OLIVE "Oliva"
  #define TXT_LIGHTGREY "Gris Claro"
  #define TXT_DARKGREY "Gris Oscuro"
  #define TXT_BLUE "Azul"
  #define TXT_GREEN "Verde"
  #define TXT_CYAN "Cyan"
  #define TXT_RED "Rojo"
  #define TXT_MAGENTA "Magenta"
  #define TXT_YELLOW "Amarillo"
  #define TXT_WHITE "Blanco"
  #define TXT_ORANGE "Naranja"
  #define TXT_GREENYELLOW "Verde Amarillo"
  #define TXT_PINK "Rosa"
  #define TXT_COLOR "Colores Custom"
  #define TXT_SET_FGCOLOR "COLOR PRINCIPAL"
  #define TXT_SET_BGCOLOR "COLOR DE FONDO"
  #define TXT_THEME "Color Tema"
  #define TXT_QR_CODES "Codigos QR"
#endif